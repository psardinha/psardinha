...
- [workload-aware-kubernetes-autoscaling](https://github.com/psardinha/workload-aware-kubernetes-autoscaling) - An event-driven Kubernetes platform demonstrating workload-aware autoscaling, where business-weighted customer processing delay drives scaling decisions through a custom Kubernetes controller.
